...
This installer was executed to bootstrap the workspace. The canonical runtime spec now lives in `AGENTS.md`. All future sessions should read only `AGENTS.md`.
...
Copy everything from the next heading through "End of canonical spec." into `AGENTS.md` without alteration.
